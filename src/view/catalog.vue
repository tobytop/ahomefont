<template scoped>
  <div style="background-color:#f7f8fa;min-height:100vh;">
    ...
    <template #right-icon>
      <div class="search-divid"></div>
      <div>
        <van-icon name="search" color="#2eb2a1" size="20" />
      </div>
    </template>
    </van-search>
    <van-row style="margin-bottom:50px;padding-top:55px;">
      <van-col span="5">
        <van-sidebar v-model="activeKey" style="position:fixed;width:100%;">
          <van-sidebar-item title="全部" />
          <van-sidebar-item title="保洁服务" />
